...
from utils.utils import read_examples, bow_with_tfidf, build_matrix, create_hyperparams_grid
...
create_hyperparams_grid(X_train=X_train, y_train=y_train, X_test=X_test, y_test=y_test, k=args.k, indices=indices)